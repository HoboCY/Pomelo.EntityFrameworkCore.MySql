...
public class NavigationsIncludeMySqlTest(NavigationsMySqlFixture fixture, ITestOutputHelper testOutputHelper)
    : NavigationsIncludeRelationalTestBase<NavigationsMySqlFixture>(fixture, testOutputHelper)
{
