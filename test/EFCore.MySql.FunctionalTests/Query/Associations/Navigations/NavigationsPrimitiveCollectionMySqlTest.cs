...
public class NavigationsPrimitiveCollectionMySqlTest(NavigationsMySqlFixture fixture, ITestOutputHelper testOutputHelper)
    : NavigationsPrimitiveCollectionRelationalTestBase<NavigationsMySqlFixture>(fixture, testOutputHelper)
{
