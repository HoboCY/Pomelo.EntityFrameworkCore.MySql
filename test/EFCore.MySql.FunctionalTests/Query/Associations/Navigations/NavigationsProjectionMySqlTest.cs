...
public class NavigationsProjectionMySqlTest(NavigationsMySqlFixture fixture, ITestOutputHelper testOutputHelper)
    : NavigationsProjectionRelationalTestBase<NavigationsMySqlFixture>(fixture, testOutputHelper)
{
