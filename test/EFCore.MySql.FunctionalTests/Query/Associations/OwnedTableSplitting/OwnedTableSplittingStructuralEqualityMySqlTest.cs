...
public class OwnedTableSplittingStructuralEqualityMySqlTest(
    OwnedTableSplittingMySqlFixture fixture,
    ITestOutputHelper testOutputHelper)
    : OwnedTableSplittingStructuralEqualityRelationalTestBase<OwnedTableSplittingMySqlFixture>(fixture, testOutputHelper)
{
