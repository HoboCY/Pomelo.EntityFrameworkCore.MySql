...
public class OwnedTableSplittingPrimitiveCollectionMySqlTest(
    OwnedTableSplittingMySqlFixture fixture,
    ITestOutputHelper testOutputHelper)
    : OwnedTableSplittingPrimitiveCollectionRelationalTestBase<OwnedTableSplittingMySqlFixture>(fixture, testOutputHelper)
{
