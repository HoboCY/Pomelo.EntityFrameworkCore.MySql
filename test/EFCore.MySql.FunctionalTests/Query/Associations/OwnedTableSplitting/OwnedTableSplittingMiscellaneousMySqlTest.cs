...
public class OwnedTableSplittingMiscellaneousMySqlTest(
    OwnedTableSplittingMySqlFixture fixture,
    ITestOutputHelper testOutputHelper)
    : OwnedTableSplittingMiscellaneousRelationalTestBase<OwnedTableSplittingMySqlFixture>(fixture, testOutputHelper)
{
