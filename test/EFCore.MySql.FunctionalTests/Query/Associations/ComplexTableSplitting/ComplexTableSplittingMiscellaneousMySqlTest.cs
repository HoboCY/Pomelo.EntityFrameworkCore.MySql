...
public class ComplexTableSplittingMiscellaneousMySqlTest(
    ComplexTableSplittingMySqlFixture fixture,
    ITestOutputHelper testOutputHelper)
    : ComplexTableSplittingMiscellaneousRelationalTestBase<ComplexTableSplittingMySqlFixture>(fixture, testOutputHelper)
{
