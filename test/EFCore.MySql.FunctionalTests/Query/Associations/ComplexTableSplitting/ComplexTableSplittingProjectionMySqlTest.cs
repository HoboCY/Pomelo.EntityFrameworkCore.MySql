...
public class ComplexTableSplittingProjectionMySqlTest(
    ComplexTableSplittingMySqlFixture fixture,
    ITestOutputHelper testOutputHelper)
    : ComplexTableSplittingProjectionRelationalTestBase<ComplexTableSplittingMySqlFixture>(fixture, testOutputHelper)
{
