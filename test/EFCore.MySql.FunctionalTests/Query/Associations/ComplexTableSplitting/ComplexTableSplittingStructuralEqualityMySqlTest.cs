...
public class ComplexTableSplittingStructuralEqualityMySqlTest(
    ComplexTableSplittingMySqlFixture fixture,
    ITestOutputHelper testOutputHelper)
    : ComplexTableSplittingStructuralEqualityRelationalTestBase<ComplexTableSplittingMySqlFixture>(fixture, testOutputHelper)
{
