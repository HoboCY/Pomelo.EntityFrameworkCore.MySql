...
public class OwnedNavigationsSetOperationsMySqlTest(
    OwnedNavigationsMySqlFixture fixture,
    ITestOutputHelper testOutputHelper)
    : OwnedNavigationsSetOperationsRelationalTestBase<OwnedNavigationsMySqlFixture>(fixture, testOutputHelper)
{
