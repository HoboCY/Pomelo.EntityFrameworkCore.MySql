...
public class OwnedNavigationsStructuralEqualityMySqlTest(
    OwnedNavigationsMySqlFixture fixture,
    ITestOutputHelper testOutputHelper)
    : OwnedNavigationsStructuralEqualityRelationalTestBase<OwnedNavigationsMySqlFixture>(fixture, testOutputHelper)
{
