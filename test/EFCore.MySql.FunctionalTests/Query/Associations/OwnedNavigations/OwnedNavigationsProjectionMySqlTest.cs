...
public class OwnedNavigationsProjectionMySqlTest(OwnedNavigationsMySqlFixture fixture, ITestOutputHelper testOutputHelper)
    : OwnedNavigationsProjectionRelationalTestBase<OwnedNavigationsMySqlFixture>(fixture, testOutputHelper)
{
