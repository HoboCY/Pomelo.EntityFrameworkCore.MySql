...
public class OwnedNavigationsMiscellaneousMySqlTest(
    OwnedNavigationsMySqlFixture fixture,
    ITestOutputHelper testOutputHelper)
    : OwnedNavigationsMiscellaneousRelationalTestBase<OwnedNavigationsMySqlFixture>(fixture, testOutputHelper)
{
